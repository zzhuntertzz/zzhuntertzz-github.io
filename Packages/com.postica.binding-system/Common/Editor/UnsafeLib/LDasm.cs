...
{
    /// <summary>
    /// Used to calculate the length of assembly instructions, using the algorithm from BlackBone's LDasm.c, which I translated into C#.
    /// </summary>
    public unsafe class LDasm
    {
        ...
        /// <summary>
        /// Calculates the minimum length of instructions that is greater than or equal to the specified size in bytes.
        /// </summary>
        ...
        {
            if (IsARM())
                return (uint)((size + 3) / 4) * 4; // This is the length in JIT mode, thumb is no longer supported
        ...
        /// <summary>
        /// Calculate the length of thumb instructions
        /// </summary>
        /// <param name="code"></param>
